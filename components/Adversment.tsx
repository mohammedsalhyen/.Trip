...
const Adversment = () => {
    return (
        <div className='section-bg my-10'>
            <div className='container w-full text-white py-10 padding-container mx-auto flex justify-between items-center xs:flex-col sm:flex-row'>
                ...
                <div className='w-full xs:text-center sm:text-start flex-1'
